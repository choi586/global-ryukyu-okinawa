...
- Posts, carousel captions, attachments and bibliography remain in their source language, without additional original-language notices. The dictionary translates UI/static institute content only; it must never translate arbitrary database content by matching titles.
